...
#    прибавьте к числу 2 и выведите результат на экран. Если возникла ошибка,
#    прочитайте ее, вспомните урок и постарайтесь устранить ошибку.
...
# Можно while true, тогда цикл крутится до команды break
# while True:
#     number = int(input('Введите число: '))
...
elif age > 30 and age <= 40 and (weight < 50 or weight >= 120): # скобки для надежности!
